        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {(Array.isArray(cards) ? cards : []).map(card => (
              <div
                key={card.id}
                className="bg-white rounded-lg border border-surface-border px-5 py-4 flex items-center gap-4 transition-shadow hover:shadow-amex-sm"
              >
